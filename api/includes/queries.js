...
(function() {
  ...
  exports.isConclusion = "RETURN ( FOR e IN GRAPH_EDGES(@graphName, @stmtId, {edgeCollectionRestriction: 'conclusion'}) FILTER e.author == @authorId COLLECT WITH COUNT INTO length RETURN length )[0] != 0";

  exports.isPremise = "RETURN ( FOR e IN GRAPH_EDGES(@graphName, @stmtId, {edgeCollectionRestriction: 'premise'}) FILTER e.author == @authorId COLLECT WITH COUNT INTO length RETURN length )[0] != 0";
